...
+ (WToast *)__createWithText:(NSString *)text {
    ...
    return [self __createWithText:text backgroundcolor:RGBA(0, 0, 0, 0.8f) textColor:RGB(255, 255, 255)];
}

// MI
+ (WToast *)__createWithText:(NSString *)text backgroundcolor:(UIColor *)backgroundColor textColor:(UIColor *)textColor{
    float screenWidth;
...
{
    WToast *toast = [WToast __createWithText:text backgroundcolor:backgroundColor textColor:textColor];
    toast.length = length;
