...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        /////
        FBShimmeringView *_shimmeringView = [[FBShimmeringView alloc] initWithFrame:label.frame];
        _shimmeringView.shimmering = YES;
//        _shimmeringView.shimmeringBeginFadeDuration = 10.0f;
//        _shimmeringView.shimmeringSpeed = 200;
//        _shimmeringView.shimmeringPauseDuration = 10.0f;
        _shimmeringView.shimmeringOpacity = 0.6;
...
- (void)launchExecution {
    ...
    [targetForExecution performSelector:@selector(methodForExecution) withObject:objectForExecution];
